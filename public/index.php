...
<body class="gradient-bg min-h-screen text-gray-800">
    ...
    <main class="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div class="max-w-4xl mx-auto mb-8 bg-red-50 border border-red-200 text-red-700 px-5 py-4 rounded-xl text-sm font-medium flex items-start gap-2">
            ...
            <span><?= htmlspecialchars($_SESSION['submit_error']) ?></span>
        </div>
        <?php unset($_SESSION['submit_error']); endif; ?>
